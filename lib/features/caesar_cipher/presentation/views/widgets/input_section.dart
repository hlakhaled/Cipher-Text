...
class InputSection extends StatelessWidget {
              ...
              child: isMobile
                  ? Column(
                      ...
                      children: [
                        ...
                        _buildShiftInput(context, state),
                      ],
                    )
                  : Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Expanded(
                          flex: 1,
                          child: _buildShiftInput(context, state),
                        ),
                      ],
                    ),
            ),
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: state.isAnimating
                        ? null
                        : () => context.read<CaesarCubit>().runAnimation(),
                  ...
                  OutlinedButton.icon(
                    onPressed: () =>
                        context.read<CaesarCubit>().resetAnimation(),
  ...
  Widget _buildPlainTextInput(BuildContext context, CaesarActive state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        TextFormField(
          ...
          onChanged: (val) => context.read<CaesarCubit>().updateText(val),
  ...
  Widget _buildShiftInput(BuildContext context, CaesarActive state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Shift (key)', style: AppStyles.body),
        const SizedBox(height: 12),
        TextFormField(
          initialValue: state.shift.toString(),
          style: AppStyles.body,
          keyboardType: TextInputType.number,
          onChanged: (val) =>
              context.read<CaesarCubit>().updateShift(int.tryParse(val) ?? 0),
          decoration: InputDecoration(
            filled: true,
            fillColor: AppColors.background,
            border: OutlineInputBorder(
  ...
  Widget _buildModeButton(
    ...
    return InkWell(
      onTap: () => context.read<CaesarCubit>().setMode(isEncryptValue),
      borderRadius: BorderRadius.circular(16),
